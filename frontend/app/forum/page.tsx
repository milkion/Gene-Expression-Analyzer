...
import background from "@/public/background4.png";
					...
					<div className="backdrop-blur-md bg-white/50 min-h-screen rounded-3xl py-10 px-10 border border-white/40 shadow-xl">
						...
						{loading ? (
							...
							<p className="text-center text-red-500 py-8">
								Error loading posts: {queryError.message}
							</p>
							...
							<div className="space-y-4">
								{filteredPosts.map((post) => (
									<div
										key={post.id}
										className="bg-white/40 backdrop-blur-sm rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow cursor-pointer border border-white/40"
										...
										<div className="flex justify-between items-start">
											...
											<button
												...
												className={`text-gray-400 hover:text-red-500 ${
													currentUserId !== post.author.id ? "hidden" : ""
												}`}
											>
												<svg
